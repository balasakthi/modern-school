...
!(function ($) {
  ...
  (MainApp.prototype.initSlimscroll = function () {
    ...
    (MainApp.prototype.activateMenuItem = function () {
      // === following js will activate the menu in left side
      // bar based on url ====
      $("#sidebar-menu a").each(function () {
        if (this.href == window.location.href) {
          $(this).addClass("active");
          $(this).parent().addClass("active"); // add
          // active
          // to
          // li
          // of
          ...
          // current
          // link
          $(this).parent().parent().prev().addClass("active"); // add
          // active
          // class
          // to an
          // anchor
          $(this).parent().parent().parent().addClass("active"); // add
          // active
          // class
          // to an
          // anchor
          $(this).parent().parent().prev().click(); // click the item to
          // make it drop
        }
      });
    }),
...
/*
 * document.onkeydown = function(e) { if (e.ctrlKey && (e.keyCode === 67 ||
 * e.keyCode === 86 || e.keyCode === 85 || e.keyCode === 117)) { alert('This is
 * not allowed'); return false; } else { return true; } };
 */
